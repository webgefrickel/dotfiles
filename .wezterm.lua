...
wezterm.on('gui-startup', function()
  ...
  local default_tab, default_pane, window = mux.spawn_window({ cwd = home_dir .. '/Downloads' })
  ...
  local key_tab, key_pane = window:spawn_tab({ cwd = home_dir })
  ...
  key_tab:set_title('kanata')
  key_pane:send_text('sudo kanata -c ~/.config/kanata/config.kbd\n')
